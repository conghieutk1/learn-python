...
```bash
py -3 rename-files.py "C:\path\to\folder" --recursive --ext "jpg,png,txt" --sort name --start 1 --step 1 --prefix "PRE_" --suffix "_SFX" --find "REGEX" --repl "REPL" --template "{prefix}{num:03d}_{stem}{suffix}{ext}" --apply --log ".rename_log.csv"
```
